...
class S3TreeDataProvider {
    ...
    LoadLogGroupNodeList() {
        ...
        for (var lg of this.LogGroupList) {
            ...
            let treeItem = new S3TreeItem_1.S3TreeItem(lg[1], S3TreeItem_1.TreeItemType.LogGroup);
    ...
    LoadRegionNodeList() {
        ...
        for (var lg of this.LogGroupList) {
            ...
            if (this.GetRegionNode(lg[0]) === undefined) {
                let treeItem = new S3TreeItem_1.S3TreeItem(lg[0], S3TreeItem_1.TreeItemType.Region);
                treeItem.collapsibleState = vscode.TreeItemCollapsibleState.Collapsed;
                treeItem.Region = lg[0];
    ...
    LoadLogStreamNodeList() {
        ...
        for (var lg of this.LogStreamList) {
            ...
            let treeItem = new S3TreeItem_1.S3TreeItem(lg[2], S3TreeItem_1.TreeItemType.LogStream);
            treeItem.Region = lg[0];
            treeItem.LogGroup = lg[1];
    ...
    GetNodesRegionLogGroupLogStream(node) {
        ...
        else if (node.TreeItemType === S3TreeItem_1.TreeItemType.Region) {
            result = this.GetLogGroupNodesParentRegion(node);
        }
        else if (node.TreeItemType === S3TreeItem_1.TreeItemType.LogGroup) {
